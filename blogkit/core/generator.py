...
12. ORIGINAL VALUE — NEVER A REWRITE OF THE NEWS: The [Source Data] is raw material, not a script to paraphrase. A reader who already saw those headlines must still finish this piece materially better informed. Add what the sources lack on their own: the synthesis across the separate items, the second-order consequences, the trade-offs an operator actually weighs, and a concrete, usable takeaway. If everything here could be gotten by skimming the source articles, the piece has failed its purpose — rebuild it around your analysis, not a recap. Open on your own assessment (never "Company X announced..."), and close with specific, actionable guidance — what changes for the reader, what to watch, what to decide — not a summary of what was said.
""".strip()
